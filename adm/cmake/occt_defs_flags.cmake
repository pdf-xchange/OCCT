...
elseif (CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX OR (CMAKE_CXX_COMPILER_ID MATCHES "[Cc][Ll][Aa][Nn][Gg]"))
  ...
  if (BUILD_SHARED_LIBS)
    ...
    elseif(NOT WIN32)
      set (CMAKE_SHARED_LINKER_FLAGS "-Wl,--no-undefined -Wl,--as-needed -lm ${CMAKE_SHARED_LINKER_FLAGS}")
    endif()
  endif()
endif()
...
if (EMSCRIPTEN)
  string (REGEX MATCH "MALLOC=mimalloc" IS_MIMALLOC1 "${CMAKE_SHARED_LINKER_FLAGS}")
  string (REGEX MATCH "MALLOC=mimalloc" IS_MIMALLOC2 "${CMAKE_EXE_LINKER_FLAGS}")
  if (IS_MIMALLOC1 OR IS_MIMALLOC2)
