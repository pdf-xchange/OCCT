...
private:
  ...
  XCAFDimTolObjects_DatumModifWithValue myModifierWithValue = XCAFDimTolObjects_DatumModifWithValue_None;
  Standard_Real myValueOfModifier = 0.0;
  TopoDS_Shape myDatumTarget;
  Standard_Integer myPosition = 0;
  Standard_Boolean myIsDTarget = false;
  Standard_Boolean myIsValidDT = false;
  XCAFDimTolObjects_DatumTargetType myDTargetType = XCAFDimTolObjects_DatumTargetType_Point;
  Standard_Real myLength = 0.0;
  Standard_Real myWidth = 0.0;
  Standard_Integer myDatumTargetNumber = 0;
  gp_Ax2 myAxis;
  gp_Ax2 myPlane;
  gp_Pnt myPnt;
  gp_Pnt myPntText;
  Standard_Boolean myHasPlane = false;
  Standard_Boolean myHasPnt = false;
