...
#ifndef Image_RWWinCodec_HeaderFile
#define Image_RWWinCodec_HeaderFile

#include <Image_RWPixMap.hxx>

//! Class for loading/storing image pixmap from/into external file using WinCodec library.
//! Supported image formats: BMP, PNG, JPEG, TIFF, GIF.
class Image_RWWinCodec : public Image_RWPixMap
{
  DEFINE_STANDARD_RTTIEXT(Image_RWWinCodec, Image_RWPixMap)
public:

  //! Constructor.
  Standard_EXPORT Image_RWWinCodec();
...
#endif // Image_RWWinCodec_HeaderFile
