...
#ifndef Image_RWPNG_HeaderFile
#define Image_RWPNG_HeaderFile

#include <Image_RWPixMap.hxx>

//! Class for storing image pixmap into PNG file.
class Image_RWPNG : public Image_RWPixMap
{
  DEFINE_STANDARD_RTTIEXT(Image_RWPNG, Image_RWPixMap)
public:

  //! Constructor.
  Standard_EXPORT Image_RWPNG();
